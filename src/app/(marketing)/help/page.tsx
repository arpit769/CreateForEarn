  ...
  return (
    <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '120px 24px 64px', color: 'var(--text-secondary)' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '24px', marginBottom: '64px' }}>
        {/* Discord Card */}
        <div style={{ padding: '32px', background: 'var(--bg-elevated)', border: '1px solid var(--border-subtle)', borderRadius: '24px', textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'space-between' }}>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '56px', height: '56px', borderRadius: '16px', background: 'rgba(88, 101, 242, 0.1)', marginBottom: '16px' }}>
              <DiscordIcon size={28} color="#5865F2" />
            </div>
            <h3 style={{ fontSize: '18px', fontWeight: 700, color: 'var(--text-primary)', marginBottom: '12px' }}>Discord Community</h3>
            <p style={{ fontSize: '14px', color: 'var(--text-muted)', marginBottom: '24px', lineHeight: 1.5 }}>Join our community to chat with other creators and get direct support.</p>
          </div>
          <a href="https://discord.gg/5qu5s87kKu" target="_blank" rel="noopener noreferrer" style={{ color: '#5865F2', fontWeight: 600, textDecoration: 'none' }}>Join Discord →</a>
        </div>

        {/* Telegram Card */}
        <div style={{ padding: '32px', background: 'var(--bg-elevated)', border: '1px solid var(--border-subtle)', borderRadius: '24px', textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'space-between' }}>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '56px', height: '56px', borderRadius: '16px', background: 'rgba(36, 161, 222, 0.1)', marginBottom: '16px' }}>
              <TelegramIcon size={28} color="#24A1DE" />
            </div>
            <h3 style={{ fontSize: '18px', fontWeight: 700, color: 'var(--text-primary)', marginBottom: '12px' }}>Telegram Channel</h3>
            <p style={{ fontSize: '14px', color: 'var(--text-muted)', marginBottom: '24px', lineHeight: 1.5 }}>Get instant updates, announcements, and quick support.</p>
          </div>
          <a href="https://t.me/+S9XRvJ5mELkyYmI1" target="_blank" rel="noopener noreferrer" style={{ color: '#24A1DE', fontWeight: 600, textDecoration: 'none' }}>Join Telegram →</a>
        </div>

        {/* FAQs Card */}
        <div style={{ padding: '32px', background: 'var(--bg-elevated)', border: '1px solid var(--border-subtle)', borderRadius: '24px', textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'space-between' }}>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '56px', height: '56px', borderRadius: '16px', background: 'rgba(168, 85, 247, 0.1)', marginBottom: '16px' }}>
              <HelpCircle size={28} color="var(--accent-purple)" />
            </div>
            <h3 style={{ fontSize: '18px', fontWeight: 700, color: 'var(--text-primary)', marginBottom: '12px' }}>FAQs</h3>
            <p style={{ fontSize: '14px', color: 'var(--text-muted)', marginBottom: '24px', lineHeight: 1.5 }}>Check if your question is already answered in our FAQ documentation.</p>
          </div>
